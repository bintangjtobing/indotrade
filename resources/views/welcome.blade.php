        ...
        <div class="container">
          ...
          <div class="topbar-right-items pull-right">
            <ul class="toplist toppadding">
              ...
              <li class="last"><a href="#">Create An Account</a></li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-12 nopadding">
        <div class="header-section white dark-dropdowns style1 links-dark pin-style">
          <div class="container">
            <div class="mod-menu">
              <div class="row">
                <div class="col-sm-3"> <a href="index.html" title="" class="logo mar-4"> <img
                    ...
                    <div id="menu" class="collapse">
                      <ul class="nav navbar-nav">
                        ...
                        <li> <a href="page-about2.html">Pages</a> <span class="arrow"></span>
                          <ul class="dm-align-2">
                            <li> <a href="#">About <span class="sub-arrow dark pull-right"><i class="fa fa-angle-right"
                            ...
                            <li> <a href="#">Contact<span class="sub-arrow dark pull-right"><i class="fa fa-angle-right"
                                    aria-hidden="true"></i></span> </a> <span class="arrow"></span>
                              <ul>
                        ...
                        <li> <a href="page-about4.html">Features</a> <span class="arrow"></span>
                          <ul class="dm-align-2">
                            ...
                            <li> <a href="#">Videos<span class="sub-arrow dark pull-right"><i class="fa fa-angle-right"
                                    aria-hidden="true"></i></span> </a> <span class="arrow"></span>
                              <ul>
                        ...
                        <li class="mega-menu"> <a href="portfolio-full-width.html">Portfolio</a> <span
                            class="arrow"></span>
                          <ul>
                        ...
                        <li class="mega-menu five-col"> <a href="shortcodes-carousel-sliders.html">Shortcodes</a> <span
                            class="arrow"></span>
                          <ul>
                        ...
                        <li class="right active"> <a href="#">Shop</a> <span class="arrow"></span>
                          <ul>
                            <li> <a href="shop-full-width.html">Full Width</a> </li>
                            <li class="active"> <a href="shop-left-sidebar.html">Left Sidebar</a> </li>
      ...
      <section class="section-side-image clearfix">
        <div class="img-holder col-md-12 col-sm-12 col-xs-12">
          <div class="background-imgholder" style="background:url(http://via.placeholder.com/1500x1000);"><img
              class="nodisplay-image" src="images/header-inner-2.jpg" alt="" /> </div>
        </div>
              ...
              <div class="header-inner less-height">
                <div class="overlay">
                  <div class="text text-center">
                    <h3 class="uppercase text-white less-mar-1 title">Shop Left Sidebar</h3>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <ol class="breadcrumb">
                  ...
                  <li><a href="#">Shop</a></li>
                  <li class="current"><a href="#">Shop Left Sidebar</a></li>
                </ol>
              </div>
        ...
        <div class="container">
          <div class="row no-gutter">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <div class="sp-top-banner-1">
                <div class="img-box">
                  <div class="overlay">
                    <h1 class="text-white font-weight-6 less-mar-1">women’s</h1>
                    <h2 class="text-white font-weight-3">Collection</h2>
                    <h6 class="text-white">Fashion</h6>

                    <div class="clearfix"></div>
                    <br />
                    <a class="btn btn-border white uppercase btn-small" href="#">Shop Now</a>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="sp-top-banner-2">
                <div class="img-box">
                  <div class="overlay">
                    <h1 class="text-white font-weight-6 less-mar-1">Men’s</h1>
                    <h2 class="text-white font-weight-3">Collection</h2>
                    <h6 class="text-white">Fashion</h6>
                  ...
                  <img src="http://via.placeholder.com/500x700" alt="" />
                </div>
              </div>
            </div>
            <!--end item-->
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="sp-top-banner-2">
                <div class="img-box">
                  <div class="overlay">
                    <h1 class="text-white font-weight-6 less-mar-1">Watches</h1>
                    <h2 class="text-white font-weight-3">Collection</h2>
                    <h6 class="text-white">Fashion</h6>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-3">
              ...
              <div class="sidebar-item-holder">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 nopadding">
                  <div class="imgbox-small left"> <img src="http://via.placeholder.com/80x80" alt=""
                      class="img-responsive" /></div>
                  <div class="text-box-right">
                    <h6 class="uppercase nopadding"><a href="#" class="text-hover-gyellow">Nullam turpis Cras
                        dapibusscing</a></h6>
                    <div class="blog-post-info padding-top-1"> <span> By codelayers</span> <span> 15 Comments</span>
                    </div>
                  </div>
                </div>
                <!--end post-->
            ...
            <div class="col-md-9">
              ...
              <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="sp-feature-box-3 margin-bottom">
                  <div class="img-box"> <a href="#" class="view-btn uppercase">View</a>
                    ...
                    <img src="http://via.placeholder.com/600x700" alt="" class="img-responsive" />
                  </div>
                  <div class="clearfix"></div>
                  <br />
              ...
              <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="sp-feature-box-3 margin-bottom">
                  <div class="img-box"> <a href="#" class="view-btn uppercase">View</a> <img
                      src="http://via.placeholder.com/600x700" alt="" class="img-responsive" /> </div>
                  <div class="clearfix"></div>
                  <br />
                  <h5 class="less-mar-1">Mens Suit</h5>
                  <p>Lorem ipsum dolor sit amet</p>
                  <h5 class="text-primary">$ 25.00–$ 29.00</h5>
                  <br />
                  <a class="btn btn-border light btn-small" href="#">Add to cart</a>
              ...
              <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="sp-feature-box-3 margin-bottom">
                  ...
                  <div class="clearfix"></div>
                  <br />
                  <h5 class="less-mar-1">Leather Bag</h5>
                  <p>Lorem ipsum dolor sit amet</p>
                  <h5 class="text-primary">$ 25.00–$ 29.00</h5>
                  <br />
                  <a class="btn btn-border light btn-small" href="#">Add to cart</a>
              ...
              <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="sp-feature-box-3 margin-bottom">
                  ...
                  <div class="clearfix"></div>
                  <br />
                  <h5 class="less-mar-1">Women's Casuals</h5>
                  <p>Lorem ipsum dolor sit amet</p>
                  <h5 class="text-primary">$ 25.00–$ 29.00</h5>
                  <br />
                  <a class="btn btn-border light btn-small" href="#">Add to cart</a>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-12 text-center">
              <h4 class=" uppercase text-white font-weight-3">SIGN UP FOR OUR NEWSLETTER & PROMOTIONS</h4>
          ...
          <div class="row"> <br />
            <div class="col-md-3 col-sm-12 colmargin clearfix margin-bottom">
              ...
              <ul class="fo-address-info border-light">
                ...
                <li class="last"><i class="fa fa-envelope"></i> Email: email@example.com </li>
              </ul>
            </div>
            <!--end item-->
              ...
              <div class="item-holder">
                ...
                <div class="fo-posts">
                  ...
                  <div class="text-box-right">
                    ...
                    <p>$25.99</p>
                    <div class="post-info text-light"> <span><i class="fa fa-star" aria-hidden="true"></i></span>
                      <span><i class="fa fa-star" aria-hidden="true"></i></span> <span><i class="fa fa-star"
                          aria-hidden="true"></i></span> <span><i class="fa fa-star" aria-hidden="true"></i></span>
                      <span><i class="fa fa-star" aria-hidden="true"></i></span> </div>
                  </div>
                </div>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-3 col-sm-12 col-xs-12 bmargin">
              <p>Copyright © 2019 codelayers | All Rights Reserved.</p>
            </div>
            <!--end item-->
